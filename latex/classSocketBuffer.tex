...
\index{Socket\+Buffer@{Socket\+Buffer}!Socket\+Buffer@{Socket\+Buffer}}
...
\index{read@{read}!Socket\+Buffer@{Socket\+Buffer}}
...
Reads a line of text from a connected socket. Reads characters from the socket and stores them into {\itshape str} until a newline is read (character '~\newline
...
Reads a line of text from a connected socket. Reads characters from the socket and stores them into {\itshape str} until\+: a) len-\/1 bytes are read, b) a newline is read (character '~\newline
...
\index{write@{write}!Socket\+Buffer@{Socket\+Buffer}}
...
Sends a line of text to a connected socket. Same effect as \hyperlink{classSocketBuffer_a26cf495283bfd370bd0c1f1503aa3a23}{write()} except that a newline (character '~\newline
